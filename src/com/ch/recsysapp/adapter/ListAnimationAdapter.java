 ...
 * 
 */
public class ListAnimationAdapter extends GPlusListAdapter {
	...
	public ListAnimationAdapter(Context context,
	...
	protected View getRowView(int position, View convertView, ViewGroup parent) {
		...
		holder.text2
				.setText("  兰戈（约翰尼·德普 Johnny Depp 配音）是一只干瘦、翠绿的蜥蜴，他住在鱼缸里，蓝天白云椰子树的假相让他 ");
