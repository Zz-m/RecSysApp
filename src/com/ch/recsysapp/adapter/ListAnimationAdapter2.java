...
import com.ch.recsysapp.http.ImageDownloader;
 ...
 * 
 */
public class ListAnimationAdapter2 extends GNowListAdapter {
	...
	public ListAnimationAdapter2(Context context,
	...
	protected View getRowView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			convertView = LayoutInflater.from(context).inflate(
					R.layout.activity_main_lay1_itemsyle, parent, false);
		...
		holder.text.setText("标题标题 " + position);
		holder.text2
				.setText("  公元2700年，人类文明高度发展，却因污染和生活垃圾大量增加使得地球不再适于人类居住。地球人被迫乘坐飞船离开故乡，进行一次漫长无边的宇宙之旅。 ");
		holder.image.setImageResource(R.drawable.cat2);
		// imageDownloader.download(URLS[position], holder.image);//线程下载的时候开
